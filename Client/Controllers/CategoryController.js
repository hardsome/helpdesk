...
co calling for model may look like this
            ...
            DB.Execute( "filesystem",   "Category","List",  args, UpdateDOM);
            DB.Execute( "remoteserver", "Category","List",  args, UpdateDOM);
            DB.Execute( "localstorage", "Category","List",  args, UpdateDOM);
            //or call to Client side Model layer for the model 
            CategoryHelper.List(args, UpdateDOM);
...
*/
      ...
      var CategoryController = {
        List: function(args, callback){
            ...
            var UpdateDOM = function(Model,View) {
                ...
                if ((model != null) && (view != null)) {
                    ...
                    $("#dialog1-label").empty().append("list of Category");
                    $("#dialog1").modal("show");
                }
            }
            ...
            //get the view, async
            ViewProxy(UpdateDOM, 'Category','List');
        ...
        Create: function(args, callback){
            ...
            var UpdateDOM = function(Model,View) {
                ...
                if ((model != null) && (view != null)) {
                    ...
                    $("#dialog2-label").empty().append("Create new Category");
                    $("#dialog2").modal("show");
            ...
            UpdateDOM ({data : new DataModel.Category()});
            
            //get the view, async
            ViewProxy(UpdateDOM, 'Category','Create');
            
        },
        
        //this is called from dynamic script from the /Client/Views/Category/Create.html
        CreatePost: function(args, callback){
            ...
            var UpdateDOM = function(Model,View) {
                ...
                if ((model != null) && (view != null)) {
                    if (model.result == true) {
                        ...
                        NormalizeHash();
                        var templateOutput = Mustache.render(view, model);
                        //find the table Categorydatatable 
                        //find the last row  and inset the row with Attribute rowid='id'
                    
                        if ($("#Categorydatatable")[0]!=undefined){
                           $("#Categorydatatable tbody").append(templateOutput);
            ...
            //call for the model, async
            CategoryHelper.Create(args, UpdateDOM);
             
            //get the view, async
            ViewProxy(UpdateDOM, 'Category','CreatePost');
        ...
        Edit: function(args, callback){
            ...
            var UpdateDOM = function(Model,View) {
                ...
                if ((model != null) && (view != null)) {
                    ...
                    $("#dialog2-body").empty();
                    $("#dialog2-body").append(templateOutput);
                    $("#dialog2-label").empty().append("Update Category");
                    $("#dialog2").modal("show");
            ...
            //call for the model, async
            CategoryHelper.Read(args, UpdateDOM);
          
            //get the view, async
            ViewProxy(UpdateDOM, 'Category','Edit');
            
        },

        //this is called after receiving Template, Model of the post form
        //dynamic script from the /Client/Views/Category/Edit.html ? local router ? controller proxy ? server router ? server CategoryController.EditPost ? try render ? local CategoryController.EditPost
        EditPost: function(args, callback){
            ...
            var UpdateDOM = function(Model,View) {
                ...
                if ((model != null) && (view != null)) {
                    if (model.result == true) {
                        ...
                        //CategoryController.Row(null,id);
                        ...
                        if ($("#Categorydatatable")[0]!=undefined){
                           $("#Categorydatatable tr[rowid='" + model.data.id + "']").empty().append(templateOutput);
                        }
            ...
            //call for the model, async
            CategoryHelper.Update(args,UpdateDOM);
            
            //get the view, async
            ViewProxy(UpdateDOM, 'Category','EditPost');
        ...
        Delete: function(args, callback){
            ...
            var UpdateDOM = function(Model,View) {
                ...
                if ((model != null) && (view != null)) {
                    ...
                    $("#dialog2-body").empty();
                    $("#dialog2-body").append(templateOutput);
                    $("#dialog2-label").empty().append("Delete Category");
                    $("#dialog2").modal("show");
                }
            }
            ...
            //get the view, async
            ViewProxy(UpdateDOM, 'Category','Delete');
        ...
        DeletePost: function(args, callback){
            ...
            var UpdateDOM = function(Model,View) {
                ...
                if ((model != null) && (view != null)) {
                    if (model.result == true) {
                        ...
                        if ($("#Categorydatatable")[0]!=undefined){
                           $("#Categorydatatable tr[rowid='" + model.data.id + "']").remove();
                           CategoryListModule.disableButtons();
                        }
            ...
            //call for the model, async
            CategoryHelper.Delete(args,UpdateDOM);
            
            //get the view, async
            ViewProxy(UpdateDOM, 'Category','DeletePost');
      },
      ...
      Details: function (args, callback){
          ...
          var UpdateDOM = function(Model,View) {
              ...
              if ((model != null) && (view != null)) {
                    ...
                    $("#dialog2-body").empty();
                    $("#dialog2-body").append(templateOutput);
                    $("#dialog2-label").empty().append("Details on Category");
                    $("#dialog2").modal("show");
              }
          }
          ...
          //get the view, async
          ViewProxy(UpdateDOM, 'Category','Details');
      },
      ...
      DropDown: function (args, callback){
          ...
          //call for the model, async
          CategoryHelper.DropDown(args, UpdateDOM);
          
          //get the view, async
          ViewProxy(UpdateDOM, 'Category','DropDown');
      },
      ...
      About: function(args, callback) {
          ...
          //get the view, async
          ViewProxy(UpdateDOM, 'Category', 'About');
