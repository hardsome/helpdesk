...
co calling for model may look like this
            ...
            DB.Execute( "filesystem",   "User","List",  args, UpdateDOM);
            DB.Execute( "remoteserver", "User","List",  args, UpdateDOM);
            DB.Execute( "localstorage", "User","List",  args, UpdateDOM);
            //or call to Client side Model layer for the model 
            UserHelper.List(args, UpdateDOM);
...
*/
      ...
      var UserController = {
        List: function(args, callback){
            ...
            var UpdateDOM = function(Model,View) {
                ...
                if ((model != null) && (view != null)) {
                    ...
                    $("#dialog1-label").empty().append("list of User");
                    $("#dialog1").modal("show");
                }
            }
        ...
        Create: function(args, callback){
            ...
            var UpdateDOM = function(Model,View) {
                ...
                if ((model != null) && (view != null)) {
                    ...
                    $("#dialog2-label").empty().append("Create new User");
                    $("#dialog2").modal("show");
            ...
            UpdateDOM ({data : new DataModel.User()});
            
            //get the view, async
            ViewProxy(UpdateDOM, 'User','Create');
            
        },
        
        //this is called from dynamic script from the /Client/Views/User/Create.html
        CreatePost: function(args, callback){
            ...
            var UpdateDOM = function(Model,View) {
                ...
                if ((model != null) && (view != null)) {
                    if (model.result == true) {
                        ...
                        NormalizeHash();
                        var templateOutput = Mustache.render(view, model);
                        //find the table Userdatatable 
                        //find the last row  and inset the row with Attribute rowid='id'
                    
                        if ($("#Userdatatable")[0]!=undefined){
                           $("#Userdatatable tbody").append(templateOutput);
            ...
            //call for the model, async
            UserHelper.Create(args, UpdateDOM);
             
            //get the view, async
            ViewProxy(UpdateDOM, 'User','CreatePost');
        ...
        Edit: function(args, callback){
            ...
            var UpdateDOM = function(Model,View) {
                ...
                if ((model != null) && (view != null)) {
                    ...
                    $("#dialog2-body").empty();
                    $("#dialog2-body").append(templateOutput);
                    $("#dialog2-label").empty().append("Update User");
                    $("#dialog2").modal("show");
            ...
            //call for the model, async
            UserHelper.Read(args, UpdateDOM);
          
            //get the view, async
            ViewProxy(UpdateDOM, 'User','Edit');
            
        },

        //this is called after receiving Template, Model of the post form
        //dynamic script from the /Client/Views/User/Edit.html ? local router ? controller proxy ? server router ? server UserController.EditPost ? try render ? local UserController.EditPost
        EditPost: function(args, callback){
            ...
            var UpdateDOM = function(Model,View) {
                ...
                if ((model != null) && (view != null)) {
                    if (model.result == true) {
                        ...
                        if ($("#Userdatatable")[0]!=undefined){
                           $("#Userdatatable tr[rowid='" + model.data.id + "']").empty().append(templateOutput);
                        }
            ...
            //call for the model, async
            UserHelper.Update(args,UpdateDOM);
            
            //get the view, async
            ViewProxy(UpdateDOM, 'User','EditPost');
        ...
        Delete: function(args, callback){
            ...
            var UpdateDOM = function(Model,View) {
                ...
                if ((model != null) && (view != null)) {
                    ...
                    $("#dialog2-body").empty();
                    $("#dialog2-body").append(templateOutput);
                    $("#dialog2-label").empty().append("Delete User");
                    $("#dialog2").modal("show");
                }
            }
            ...
            //get the view, async
            ViewProxy(UpdateDOM, 'User','Delete');
        ...
        DeletePost: function(args, callback){
            ...
            var UpdateDOM = function(Model,View) {
                ...
                if ((model != null) && (view != null)) {
                    if (model.result == true) {
                        ...
                        if ($("#Userdatatable")[0]!=undefined){
                           $("#Userdatatable tr[rowid='" + model.data.id + "']").remove();
                           UserListModule.disableButtons();
                        }
            ...
            //call for the model, async
            UserHelper.Delete(args,UpdateDOM);
            
            //get the view, async
            ViewProxy(UpdateDOM, 'User','DeletePost');
      },
      ...
      Details: function (args, callback){
          ...
          var UpdateDOM = function(Model,View) {
              ...
              if ((model != null) && (view != null)) {
                    ...
                    $("#dialog2-body").empty();
                    $("#dialog2-body").append(templateOutput);
                    $("#dialog2-label").empty().append("Details on User");
                    $("#dialog2").modal("show");
              }
          }
          ...
          //get the view, async
          ViewProxy(UpdateDOM, 'User','Details');
      },
      ...
      DropDown: function (args, callback){
          ...
          //call for the model, async
          UserHelper.DropDown(args, UpdateDOM);
          
          //get the view, async
          ViewProxy(UpdateDOM, 'User','DropDown');
      },
      ...
      About: function(args, callback) {
          ...
          //get the view, async
          ViewProxy(UpdateDOM, 'User', 'About');
