    ...
    if (!(DataModel))
        var DataModel = {};
    DataModel.User = function(objOrID, UserName,FirstName,LastName ){
        this.id = null;
        ...
        if (validator.isInt(objOrID)){
            ...
            if (typeof(UserName)!='undefined')
                this.UserName = validator.toString(UserName);
                if (typeof(FirstName)!='undefined')
                this.FirstName = validator.toString(FirstName);
                if (typeof(LastName)!='undefined')
                this.LastName = validator.toString(LastName);
            ...
            if (validator.isInt(args.id))
                ...
                if (typeof(args['UserName'])!='undefined')
                  this.UserName =   validator.toString(args["UserName"]);
                if (typeof(args['FirstName'])!='undefined')
                  this.FirstName =   validator.toString(args["FirstName"]);
                if (typeof(args['LastName'])!='undefined')
                  this.LastName =   validator.toString(args["LastName"]);
    ...
    UserHelper = (function(){
      ...
      return{
          ...
          //Create a new User and save in in the DB.
          ...
          // Select all User objectss into a Array
          // return a Array of User objects - if successful, null otherwise
...
//TODO fix the range       
          ...
          // Select all User objects into a Array
          // return a Array of User objects - if successful, null otherwise
...
//change the  "UserName" to whatever you want to see in the dropdown
                          var objRow = {id :objResult.data.items[i].id ,  name: objResult.data.items[i]["UserName"] };
